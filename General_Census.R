...
## -----------------------------------------------------
##
## Notes: Using census area level data from 2017 Census
##   
##
## ---------------------------
...
pkgs = c("sp","spdep","sf","foreach","shiny" ) #Packages that interact with INLA
...
pkgs = c("dplyr", "tidyverse", "janitor"
         , "tmap", "devtools", "renv", #"Hmisc"
         , "ggplot2", "bigDM"
         , "xfun", "remotes", "maptools"
...
#ONLY install once
  ...
  devtools::install_github("menglezhang/socialfrontiers@v0.2",
...
data <- st_read(here("data", "Census_Lima", "ZONAS_CENSALES.shp")) %>% 
...
st_layers(here("data", "Census_Lima", "ZONAS_CENSALES.shp"))
